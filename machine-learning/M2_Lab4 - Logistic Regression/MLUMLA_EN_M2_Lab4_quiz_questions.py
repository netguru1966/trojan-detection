...
question_1 = Quiz(
    question={
        "question": "Why do you use pipelines?",
        "options": [
            "To remind you how to manually process the training, testing, and validation datasets",
            "To make sure that the training, testing, and validation datasets are processed differently according to the split type",
            "To provide repeatability and ensure that the training, testing, and validation datasets are all transformed the same way",
        ],
        "correctIndex": 2,
    }
)
...
question_2 = Quiz(
    question={
        "question": "Why do you evaluate the classifier?",
        "options": [
            "To see how well it performs on data that it did not see during the training process",
            "To see how well it performs on data that was used during the training process",
            "To transform the data in preparation of training",
        ],
        "correctIndex": 0,
    }
)
